...
- 当前阶段：P3 — React Workbench Shell
- 当前目标：搭建轻量 React + Vite + TypeScript Workbench shell，读取 P1/P2 API 并显示 Study Header、Run Control、Timeline、Active Task、Evidence Log 的默认/loading/error/empty 状态。
...
- 下一 Gate：完成 P3 前端 shell 构建/测试并提交，再进入 P4 Review Gate + Resume 主交互；P0 全部完成后才回到 P9.1/P6 用户实际运行确认。
