...
| # | 子计划 | 文件 | 当前 Phase | 状态 |
|---|--------|------|------------|------|
| P9.1 | Metadata-driven SDTM AE 最小信息单机 POC | [P9-metadata-driven-sdtm-ae-minimal-poc.md](plans/ongoing/P9-metadata-driven-sdtm-ae-minimal-poc.md) | P5 通用规则治理 Review 待批；发布链路已测试 | in-progress |
