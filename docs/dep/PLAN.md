...
| # | 当前 Gate | 子计划 | 状态 |
|---|----------|--------|------|
| P17 | P4 现有治理 UI 与全链路 Gate | [P17-knowledge-lifecycle-retrieval-poc.md](plans/ongoing/P17-knowledge-lifecycle-retrieval-poc.md) | P1-P3 done；P4 in progress，released Query Lab 已接通，不调用模型 |
