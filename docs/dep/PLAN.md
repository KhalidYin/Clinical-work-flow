...
| # | 当前 Gate | 子计划 | 状态 |
|---|----------|--------|------|
| P12 | P2-B3 等待 P15 Knowledge Harness POC → P16 `secret://`/受控网络 Gate → 单一 live vertical | [P12-knowledge-application-platform.md](plans/ongoing/P12-knowledge-application-platform.md) | P15 P1 已完成，P2/P3 与 P16 待执行；live 仍需用户配置与单独授权，未调用 |
| P15 | P2 真实 OpenCode、Pack Skill/MCP 与内部 Mock Model | [P15-knowledge-opencode-harness-poc.md](plans/ongoing/P15-knowledge-opencode-harness-poc.md) | P1 complete；P2 尚未开始，需按固定镜像验证版本兼容与零公网边界 |
