...
- 2026-08-09 至 2026-08-12 已完成 OpenCode `1.18.14` digest 容器准入、知识侧 `opencode-supervised` remote Attempt、显式 Compose 独立 Supervisor 及 P16 全量 Gate：标准 MCP、Receipt、Worker 零 socket/模型 secret、精确 provider/model/profile 绑定、capability 分离、全终态 secret 清理、internal client/public uplink、精确 CONNECT allow/deny/bypass、本地 TLS 假端点真实 Skill/MCP/模型工具循环、空卷 migration 与 Compose Smoke 均通过。普通 Compose 仍默认 replay；生产 Secret/runtime authority、公共研究 recording gateway 与 DeepSeek live vertical 未完成。
