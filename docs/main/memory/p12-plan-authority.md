...
**如何应用：** 当前下一任务是 P1-B0，先冻结 ModelProviderPort、Model/Prompt/Invocation、数据出站边界和 ledger-owned retry 合同，再进行 P1-B 数据库迁移。如果未来需要重启 Workflow、Agent、Project Memory 或多 Study 协作，必须基于 P12 当时已发布的外部合同新建计划，不能恢复旧 P1-P11 文件继续执行。
