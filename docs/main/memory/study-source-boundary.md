...
- `source_intake` 是 P9 Runtime prerelease ReviewPacket 扩展，只批准来源进入 Parser/Derived Gate，不批准 MappingSpec、程序执行或 canonical artifact promotion；它不属于 released Engine/Wiki 1.1.0 bundle。
