...
- [Harness 架构方向](project-harness-architecture-direction.md) — H0、OpenCode 准入、知识 remote Attempt 与显式 Compose 独立 Supervisor 离线 Gate 已完成；`secret://`、受控出站和 live vertical 仍待完成。
